...
export type BatchEvent = { type: "batchStarted"; session_id: string } | { type: "batchProgress"; session_id: string; delta: TranscriptDelta; percentage: number } | { type: "batchFailed"; session_id: string; error: string }
