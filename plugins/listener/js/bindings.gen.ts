...
export const commands = {
  ...
  async isSupportedLanguagesLive(
    provider: string,
    model: string | null,
    languages: string[],
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "plugin:listener|is_supported_languages_live",
  ...
  async suggestProvidersForLanguagesLive(
    languages: string[],
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "plugin:listener|suggest_providers_for_languages_live",
          { languages },
        ),
      };
    } catch (e) {
  ...
  async listDocumentedLanguageCodesLive(): Promise<Result<string[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "plugin:listener|list_documented_language_codes_live",
        ),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
...
export type SessionLifecycleEvent =
  ...
  | { type: "active"; session_id: string; error?: DegradedError | null }
