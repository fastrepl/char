...
export const env = createEnv({
  ...
  client: {
    ...
    VITE_OTEL_EXPORTER_OTLP_HEADERS: z.string().min(1).optional(),
    VITE_HONEYCOMB_UI_BASE_URL: z.string().url().optional(),
    VITE_HONEYCOMB_UI_TEAM: z.string().min(1).optional(),
    VITE_HONEYCOMB_UI_ENVIRONMENT: z.string().min(1).optional(),
