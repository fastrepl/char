...
This post maps the territory so you don't have to burn as many cycles.

I won't tell you "X is the best CMS."  
...
If your team is very technical and you're early-stage, this is almost always the right default. You can add a Git-based or headless CMS later without discarding anything.
...
Other players in this space include TinaCMS, Decap, etc., which many devs compare as ["Git-based CMS for React/Next"](https://dev.to/linkb15/top-5-git-based-cms-comparison-as-of-april-2024-4k1e).
...
You like the Git + MDX approach, but you want PMs / designers / marketing to be able to tweak copy and metadata without opening an IDE.
...
You define schemas, models, relationships, and the CMS exposes content via [REST/GraphQL/other APIs](https://www.sanity.io/headless-cms) to web, mobile, native apps, signage, whatever.

### Sanity

Sanity is one of the big names here:

- it offers a composable "Content Cloud" with an open-source Studio built in React/TypeScript, highly customizable, and aimed at flexible content modeling
- content is stored in their **Content Lake** as structured JSON, not HTML, so you can reuse it across multiple frontends
- it provides real-time collaboration, visual editing, and omnichannel delivery

This works well when you have multiple frontends, lots of content types, and non-technical editors who need good UX.

### Payload

Payload is a dev-first, code-first headless CMS built with Node.js, TypeScript and React, positioning itself as a Next.js-native backend framework.

- you configure everything in TypeScript
- it's [open-source](https://github.com/payloadcms/payload) (MIT), self-hostable, and can double as a headless CMS, app framework, or digital asset management layer
- it fits naturally into a modern JS/TS stack with [Next.js-based projects](https://payloadcms.com/docs/getting-started/what-is-payload)
...
- often built-in [localization, scheduling, etc.](https://www.sanity.io/headless-cms)
...
GitBook positions itself as a documentation + knowledge base platform for technical teams, with a polished block-based editor, site customization options, and Git Sync that lets you connect to GitHub/GitLab for a docs-as-code workflow.

It works well if you want:

- a hosted, beautiful docs site
- search, navigation, versioning, and collaboration
- optional [Git synchronization](https://gitbook.com/docs/guides/docs-best-practices/documentation-structure-tips) for teams that still want Markdown in repos
...
- often have built-in [AI-assisted search/summary](https://www.gitbook.com/)
...
Tools like **Nextra** are not CMS platforms, but content-focused frameworks built on Next.js that make it easy to build docs/blog sites with Markdown/MDX and opinionated themes.
...
This is the category Char's stack resembles: modern React/MDX front-end, but content-first in Git.
...
Headless CMS and hosted doc platforms feel great in the first year. Export and migration problems show up when the product is working and you're stretched thin.
...
- When non-engineers need to edit regularly  
  → I'd add a **Git-based CMS** like [Keystatic](https://keystatic.com/).
- If I ever hit real omnichannel, multi-locale complexity  
  → I'd consider [Sanity or Payload](https://nextjstemplates.com/blog/headless-cms-nextjs) and accept the trade-offs.
- For standalone internal knowledge bases  
  → I'd probably just use [GitBook](https://gitbook.com/docs) and not overthink it.
