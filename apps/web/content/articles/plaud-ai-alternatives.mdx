...
| Char                       | Control over AI stack and data | Desktop software (macOS)       | Replaceable AI layer + on-device data storage | macOS only                  | Free                        |
...
Char captures your system and microphone audio, transcribing your conversation in real-time without bots joining your calls. Once the meeting ends, it uses the transcript and any notes you might have taken to create an actionable summary. 

#### Key features

- **Plain markdown files**: Stored your data locally, works with any tool (Obsidian, Notion, VS Code)—zero lock-in
