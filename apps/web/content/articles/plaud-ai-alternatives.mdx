...
Char captures your system and microphone audio to transcribe your call in real-time without bots. Once the meeting ends, it uses the transcript and any notes you might have taken to create the perfect summary. You can then query the notes to ask specific things or create follow-up emails. 
