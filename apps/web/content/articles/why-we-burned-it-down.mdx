...
And the only way to fix it was to start over.

### The Early Mess

When Yujong and I started, we weren't working on Char.
We were trying to build an AI hardware toy that talks to kids.
But hardware was slow. Brutal. Not something two people could ship fast.
...
I wanted something simple, clean, fast. Something I'd actually use.
...
Local-first and open source aren't the same thing.
They're adjacent, but different.
...
The question we struggled with most:

> Who are your users?

We said we were focusing on enterprise, but we weren't sure.
We were still trying to figure out who we should sell to: banks, defense, military, or something else.

We were the problem, not the questions.
...
We tried to logic our way into clarity.
You can't.
...
YC was a wake-up call for me on hiring.
...
And yeah, they do. But enterprise doesn't mean local-first.
They care about compliance, SOC2, consent, legal — we weren't ready for any of that.

The whole time, my gut said:
Build for people like you.
Busy individuals who live in meetings and want a tool that just works.
...
An MVP today still has to feel complete.
It can be scrappy under the hood, but it can't feel cheap in your hands.

And if your wedge is design, like us, you don't even get that scrappy margin.
You have to nail it.
...
I've been thinking a lot about differentiators.
...
We're trying to dominate a niche that really cares.
...
It's us finally admitting what we messed up.
