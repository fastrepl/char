...
[Char](/) Char is an open-source AI notepad for meetings built for people who want complete control over their data and AI stack. It captures audio directly from your system, transcribes in real-time, and combines your notes with the transcript to generate structured summaries — all saved as plain markdown files on your device.
