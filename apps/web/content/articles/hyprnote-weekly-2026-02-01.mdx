...
The v1.0.2 stable release brings together months of work from our nightly builds into a polished, production-ready release.
...
Other improvements in v1.0.2 include sleep detection that automatically stops recording when you close your laptop lid, a redesigned settings panel, and improved authentication that persists across app updates so you don't have to re-login after every update.

## Git Plugin

We introduced a new Git plugin built on top of gix, a pure Rust implementation of Git. This work enables future features around version control and collaboration.

The plugin provides core Git operations with a modular architecture. It's not user-facing yet, but it's a building block for what comes next.

## Persistent Pinned Tabs

Pinned tabs now persist across app restarts. If you pin a session tab, it stays pinned when you reopen the app. This is one of those small improvements that makes a difference in daily use.
