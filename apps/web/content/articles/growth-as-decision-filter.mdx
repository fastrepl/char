...
During Y Combinator, Paul Graham said something that stuck: "When unsure what to do, ask — will this help us grow?"
...
PG's advice isn't about chasing growth hacks. It's about using growth as a filter for hard decisions.

When you're unsure whether to build a feature, ask: will this help us grow? When you're unsure whether to pursue a customer segment, ask the same question. Most debates inside startups happen because there's no shared framework for making the call. Growth gives you that framework.
...
The filter isn't perfect, but it's better than arguing about strategy in a Google Doc.
