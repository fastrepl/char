...
Free forever for local transcription, BYOK, and all core features. Includes customizable templates for different meeting types, and offers conversational search across meeting history. Users can connect external AI providers—zero vendor lock-in.
