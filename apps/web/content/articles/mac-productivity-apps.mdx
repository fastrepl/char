...
I've been an [Obsidian](https://www.google.com/url?q=https://obsidian.md/&sa=D&source=editors&ust=1771000364598966&usg=AOvVaw3BuiZ2NKCDRiSA5vb0cKU2) power user for years, and I'm a fan of their files over apps philosophy.

I started using it to link random thoughts together and eventually built my own plugins.

When everything's just markdown files on your computer and you can extend it however you want, you stop seeing it as an app and start seeing it as your system. That sense of ownership changes how you work.
...
- No natural language input beyond dates (check out Todoist for this)
...
If you work async and live in screenshots and screen recordings, [CleanShot X](https://www.google.com/url?q=https://cleanshot.com/&sa=D&source=editors&ust=1771000364605619&usg=AOvVaw1HJzhohEHlKcDZigtE4_qO) is essential.
...
[Hazel](https://www.google.com/url?q=https://www.noodlesoft.com/&sa=D&source=editors&ust=1771000364613390&usg=AOvVaw0BwJkCYVk6cGFJAzMEa-Ak) watches folders and runs rules automatically. For example, move PDFs to project folders, delete DMGs after install, archive old screenshots.

Unlike Cowork which uses AI to make decisions, Hazel does exactly what you tell it, forever. Set up rules once, and your downloads folder stays at zero without thinking.

Keyboard Maestro can watch folders too, but Hazel is built for files specifically—it can read PDF content, clean up app support files, and provide better reliability.
...
- Set it and forget it. It runs silently in the background for years
...
I've spent years building this setup. Some of these apps have been with me so long I forget what it was like before them. Others are new enough that I'm still discovering features. But they all share one thing: they make me think less about how I'm working so I can focus on what I'm working on.
