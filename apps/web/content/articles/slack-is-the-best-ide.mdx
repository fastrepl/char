...
meta_description: "I wear too many hats. The best way to get anything done is to work async. My center of gravity isn't an editor anymore — it's Slack."
author: "John Jeong"
category: "Tools"
date: "2026-02-17"
---

I wear too many hats. Design, dogfooding, PM, support, marketing. Context-switching is the default, not the exception.
...
Slack is where problems surface. It's where tasks get picked up. It's where the whole team can see what's in flight and what's blocked.
...
Async work compounds. You drop a task. Something picks it up. You come back later and it's done. You didn't have to sit there.

AI agents in Slack work better than managing everything in a traditional IDE for the same reason that email works better than phone calls for busy people. The IDE assumes you're there. Slack assumes you're not.
...
None of this required me to sit in one tool and focus for two hours. It all happened in pieces, async, across multiple channels. The IDE is wherever the work lives.
