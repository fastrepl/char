...
One person said: "It's more like Philz vs Peet's than anything technical."
...
Slack is good for real-time discussion. It's bad for long-term memory.

A thread happens. People contribute. The discussion ends. A week later, someone asks the same question. The thread is buried. Nobody can find it.
...
Once you have this loop — conversations to documents to diffs to shared understanding — going back to Slack-only feels broken. You notice when a good discussion happens and doesn't get captured. You feel the information loss.
