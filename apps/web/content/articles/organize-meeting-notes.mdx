...
The real problem with CRMs is the writing experience. Most of them are clunky to type in. People log notes as an afterthought and the quality suffers. The workflow that actually works is an integration between your .
