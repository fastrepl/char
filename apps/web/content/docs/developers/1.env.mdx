...
The web app also accepts optional browser observability variables:

```bash
VITE_OTEL_EXPORTER_OTLP_ENDPOINT="https://otel.char.com" # optional public browser OTLP/HTTP ingest
VITE_OTEL_EXPORTER_OTLP_HEADERS=""                       # optional browser-visible collector headers; never put Honeycomb secrets here
VITE_HONEYCOMB_UI_BASE_URL=""                           # optional, defaults to https://ui.honeycomb.io
VITE_HONEYCOMB_UI_TEAM=""                               # optional
VITE_HONEYCOMB_UI_ENVIRONMENT=""                        # optional
VITE_SENTRY_DSN=""                                      # optional
```

`VITE_OTEL_EXPORTER_OTLP_ENDPOINT` is for browser clients only. Server-side processes should use the private collector directly instead of `https://otel.char.com`.
...
OTEL_EXPORTER_OTLP_ENDPOINT=""         # optional private collector base URL, e.g. http://otel-collector:4318
OTEL_SERVICE_NAME=""                   # optional
HONEYCOMB_UI_BASE_URL=""               # optional, defaults to https://ui.honeycomb.io
HONEYCOMB_UI_TEAM=""                   # optional
HONEYCOMB_UI_ENVIRONMENT=""            # optional
SUPABASE_URL="http://127.0.0.1:54321"
