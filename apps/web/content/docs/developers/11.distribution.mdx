...
4. Create the app directory and copy files:
   ...
   cp /path/to/char/apps/desktop/flatpak/com.hyprnote.Char.yml com.hyprnote.Char/
   cp /path/to/char/apps/desktop/flatpak/com.hyprnote.Char.desktop com.hyprnote.Char/
   cp /path/to/char/apps/desktop/flatpak/com.hyprnote.Char.metainfo.xml com.hyprnote.Char/
   cp /path/to/char/apps/desktop/flatpak/pnpm-sources.json com.hyprnote.Char/
   cp /path/to/char/apps/desktop/flatpak/cargo-sources.json com.hyprnote.Char/
   ```
